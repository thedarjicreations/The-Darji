...
import { FiUser, FiLock, FiArrowRight, FiShield, FiSmile } from 'react-icons/fi';
        ...
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-gray-900 to-gray-800 text-white flex-col justify-between p-12 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-lg">
                    <h1 className="text-5xl font-black leading-tight mb-6">Join the future of fashion management.</h1>
                    <p className="text-gray-400 text-lg leading-relaxed">Start your premium journey with us today.</p>
                </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-4 bg-gray-50">
                <div className="w-full max-w-md bg-white p-8 md:p-10 rounded-3xl shadow-xl shadow-gray-200/50">
                    <div className="text-center lg:text-left mb-10">
                        ...
                        <p className="text-gray-500 font-medium">Join us to manage your boutique efficiently</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400 group-focus-within:text-darji-accent transition-colors"><FiSmile size={20} /></div>
                                <input
                                    type="text"
                                    value={name}
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-gray-500 font-medium">
                            ...
                            <Link to="/login" className="text-darji-accent font-bold hover:underline">
                                Sign In
                            </Link>
                        </p>
                    </div>
